"""
Django settings for projekku123 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-_vi)n=cd!_ixv9rd(mv)c+-$vt$oly-z@=!8gz*#x3()@^)c4!')
...
WSGI_APPLICATION = 'projekku123.wsgi.application'
